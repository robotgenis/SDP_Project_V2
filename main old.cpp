...
void Levels::draw(){
    switch(level){
        case LEVEL_MAIN_MENU: 
            ...
            LCD.DrawRectangle(80, 5, 160, 50);
            LCD.WriteAt("Game Start", 100, 80);
            LCD.DrawRectangle(80, 60, 160, 95);
            LCD.WriteAt("Display Statistics", 100, 80);
            LCD.DrawRectangle(80, 100, 160, 145);
            LCD.WriteAt("Exit", 120, 140);
            break;
